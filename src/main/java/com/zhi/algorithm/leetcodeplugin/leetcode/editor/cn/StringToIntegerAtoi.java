...
public class StringToIntegerAtoi {
    ...
    class Solution {
        ...
        public int myAtoi(String s) {
            ...
            int index = removeBlank(s);
            index = determineSign(s, index);
            if (index == -1) {
                return 0;
            }
            long res = getNum(s, index);
            if (!positive) {
                res = -res;
            }
            return res > Integer.MAX_VALUE ? Integer.MAX_VALUE : (int) (res < Integer.MIN_VALUE ? Integer.MIN_VALUE : res);
        }

        private long getNum(String s, int index) {
            if (index >= s.length()) {
                return 0;
            }
            long res = 0;
        ...
        private int determineSign(String s, int index) {
            if (index >= s.length()) {
                return -1;
            }
            if (s.charAt(index) == '+') {
        ...
        private int removeBlank(String s) {
            int i = 0;
