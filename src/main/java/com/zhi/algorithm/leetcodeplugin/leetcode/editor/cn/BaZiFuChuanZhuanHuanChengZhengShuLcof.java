...
public class BaZiFuChuanZhuanHuanChengZhengShuLcof {
    ...
    class Solution {
        public int strToInt(String str) {
            ...
            return transToNum(numStr, positive);
        }

        private String getNum(String str, int startIndex) {
        ...
        private int transToNum(String numStr, boolean positive) {
            double res = 0;
            double base = 1;
            for (int i = numStr.length() - 1; i >= 0; i--) {
                res += (numStr.charAt(i) - '0') * base;
                base *= 10;
            }
            if (!positive) {
                res = -res;
